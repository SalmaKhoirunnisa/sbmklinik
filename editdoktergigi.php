    ...
    <section id="data">
        ...
        <div class="data-terbaru-container">
            <div class="data-terbaru-header">
                <button class="btn-kembali" onclick="window.location.href='barangdoktergigi.php';">Kembali</button>
                <button class=" btn-tambah" onclick="window.location.href='barangdoktergigi.php';">Simpan</button>
            </div>
            ...
            <div class="button-form">
                <button class="btn-hapus" onclick="window.location.href='doktergigi.php';">Hapus</button>
            </div>
        </div>
    </section>
