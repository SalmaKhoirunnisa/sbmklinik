<?php
include('koneksi.php');
$idbaranggigi = $koneksi->query("SELECT * FROM baranggigi WHERE idbaranggigi = '$_GET[id]'");
$data = $idbaranggigi->fetch_assoc();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <section id="content">
        ...
        <nav>
            <div class="nav-left">
                <i class="bx bx-menu"></i>
                <a href="doktergigi.php" class="nav-link">Dokter Gigi</a>
            </div>
            <div class="nav-right">
                <a href="#" class="profile">
    ...
    if (isset($_POST['ubah'])) {
        ...
        $koneksi->query("UPDATE baranggigi SET 
        nama = '$nama',
        kategori = '$kategori',
        jumlah = '$jumlah',
        tanggalmasuk = '$tanggalmasuk',
        keterangan = '$keterangan' 
        WHERE idbaranggigi = '$_GET[id]'");
